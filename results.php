<html>
	...
	<body>
		...
		<section class="content" id="examResults">
			<article class="description" id="examResults">				
				<h1 class="green" id="exam">Результаты экзамена</h1>
				<div class="message" id="examResults">
					<i></i>
					<div class="resultedTable">
						<div class="studentName">
							<b>Студент {Full Name}</b>
							<p>Представляем ваши результаты по&nbsp;выполнению экзамена.</p>
						</div>
						<h2>Результаты практикума</h2>
						<div class="resultedValue">
							<span class="type">Всего выполнено</span>
							<span class="value">{Value} <span class="hidden">практических </span>заданий <span class="courseName">по&nbsp;курсу «Введение в&nbsp;векторную графику».</span></span>
						</div>
						<h2 id="examination">Результаты экзамена</h2>
						<div class="resultedValue" id="exam">
							<span class="type">Всего</span>
							<span class="value">{Value} задачи сдано<i class="hidden"> на&nbsp;проверку</i>.</span>
						</div>	
						<div class="resultedValue">
							<span class="type">Зачтено</span>
							<span class="value">{Value} задачи.</span>
						</div>	
						<div class="resultedValue">
							<span class="type">Допущено</span>
							<span class="value">{Value} ошибки(ок).</span>
						</div>
						<div class="resultedValue completeMark">
							<span class="type">Оценка по результатам экзамена:</span>
							<span class="value">{Value} баллов.</span>
						</div>							
					</div>
