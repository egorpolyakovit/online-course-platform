	...
	<body>
		...
		<section class="content" id="feedback">
			<article class="description" id="support">				
				<h1 id="support">Обратная связь</h1>				
				<form enctype="multipart/form-data" method="post" action="mail" id="support" class="feedback">
					<div class="feedbackLogin">
						...
						<input name="fullname" value="" type="text" required="" placeholder="Укажите ваше имя и фамилию" maxlength="255">
					</div>
					<div class="feedbackEmail">
						<label>Эл.почта:</label>
						<input name="email" value="" type="email" required="" placeholder="Укажите эл.почту" maxlength="255">
					</div>
					<label>Тема обращения</label>
					<select name="theme">
						<option>Выбрать тему</option>
						<option value="Технический вопрос">Технический вопрос</option>
						<option value="Вопрос по курсу обучения">Вопрос по курсу обучения</option>
						<option value="Аттестационный вопрос">Аттестационный вопрос</option>
						<option value="Другой вопрос">Другой вопрос</option>
					</select>
					<label>Текст вопроса</label>
                    <textarea name="text" class="input input_textarea" required="" placeholder="Укажите ваш вопрос" title="Ваш вопрос" maxlength="2000"></textarea>
                    <input type="submit" value="Отправить сообщение" id="sendButton" class="btn">
                </form>
			</article>
