<html>
	<head>
		<title>Техническая поддержка онлайн-курсов</title>
	...
	<body>
		...
		<section class="content">
			<article class="description" id="support">				
				<h1 id="support">Техническая поддержка<span class="hidden"> онлайн-курсов</span></h1>
				...
				<h2 id="popularQuestions">Популярные вопросы и ответы</h2>
				<ul id="questions">
					<li><a href="support/question-1.php" target="_blank" title="Почему не срабатывает авторизация по логину и паролю?">Почему не срабатывает авторизация по логину и паролю?</a></li>
					<li><a href="support/question-2.php" target="_blank" title="Как скопировать материалы курса обучения?">Как скопировать материалы курса обучения?</a></li>
					<li><a href="support/question-3.php" target="_blank" title="Когда происходит публикация результатов аттестации?">Когда происходит публикация результатов аттестации?</a></li>
					<li><a href="support/question-4.php" target="_blank" title="Сколько недель длится обучение по курсу?">Сколько недель длится обучение по курсу?</a></li>
					<li><a href="support/question-5.php" target="_blank" title="Возможна ли досрочная сдача экзамена по данному курсу?">Возможна ли досрочная сдача экзамена по данному курсу?</a></li>
					<li><a href="support/question-6.php" target="_blank" title="Возможна ли переаттестация по курсу обучения?">Возможна ли переаттестация по курсу обучения?</a></li>
					<li><a href="support/question-7.php" target="_blank" title="Как задать вопрос преподавателю онлайн-курса?">Как задать вопрос преподавателю онлайн-курса?</a></li>
				</ul>
				<a href="all-questions.php" title="Полный список вопросов и ответов" class="allQuestions">Полный список вопросов и ответов</a>				
			</article>
