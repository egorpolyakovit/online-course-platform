<html>
	<head>
		<title>Авторизация в курсе дистанционного обучения</title>
	...
	<body>
		...
		<section class="content" id="author">
			<article class="description" id="login">
				<h1>Авторизация в&nbsp;курсе обучения</h1>
				<form id="login" action="authorize.php">
					<div class="loginBox">
						<label>Электронная почта</label>
						<input type="email" name="email" class="loginEmail" placeholder="Введите вашу эл.почту" required>					
						<label>Пароль</label>
						<input type="password" name="password" class="loginPass" placeholder="Введите ваш пароль" required>										
					</div>
					<div class="loginRestorePass">
						<label>
							<input type="checkbox" name="remember_me" checked="checked" /><span>Запомнить <i span="hidden">пароль</i></span>
						</label>
						<a href="reset-password.php">Восстановить пароль</a>
					</div>	
					<div class="loginBox button">					
						<input type="button" value="Войти" class="btn">					
					</div>
				</form>
			</article>
