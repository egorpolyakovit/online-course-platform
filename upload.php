	...
	<body>
		...
		<section class="content">
			<article class="description">				
				<h1 class="green" id="order">Загрузка выполненного задания</h1>
				<form enctype="multipart/form-data" method="post" class="upload" action="upload-complete.php" name="upload">
					<div class="infoBlock">
						<label>Полное имя и фамилия студента</label>
						<input type="text" placeholder="Укажите полное имя и фамилию" class="fullName" name="fullName" id="cyrilic" pattern="[А-Яа-яЁё ]+">						
					</div>
					<div class="infoBlock">
						<label>Задание</label>
						<select name="workTask">
							<option value="">Выберите задание из списка</option>
							<option value="Практикум №1">Практикум №1</option>
							<option value="Практикум №2">Практикум №2</option>
							<option value="Практикум №3">Практикум №3</option>
							<option value="Практикум №4">Практикум №4</option>		
							<option value="Практикум №5">Практикум №5</option>
							<option value="Практикум №6">Практикум №6</option>
							<option value="Практикум №7">Практикум №7</option>
							<option value="Практикум №8">Практикум №8</option>
							<option value="Практикум №9">Практикум №9</option>		
							<option value="Практикум №10">Практикум №10</option>
							<option value="Экзамен. Задание 1.1. Подготовка каталога продукции гипермаркета со стандартизированной структурой по методологии БЭМ">Экзамен. Задание 1.1. Подготовка каталога продукции гипермаркета со стандартизированной структурой по методологии БЭМ</option>							
							<option value="Экзамен. Задание 1.2. Подготовка схемы аэропорта с учетом правил пассажироперевозок">Экзамен. Задание 1.2. Подготовка схемы аэропорта с учетом правил пассажироперевозок</option>
							<option value="Экзамен. Задание 1.3. Подготовка рекламной схемы описания нового смартфона с учетом актуальных технологий">Экзамен. Задание 1.3. Подготовка рекламной схемы описания нового смартфона с учетом актуальных технологий</option>
							<option value="Экзамен. Задание 2.1. Верстка целевой рекламной страницы и анимация SVG графики на основе шаблона HTML5">Экзамен. Задание 2.1. Верстка целевой рекламной страницы и анимация SVG графики на основе шаблона HTML5</option>
							<option value="Экзамен. Задание 2.2. Дизайн уникального логотипа для компании">Экзамен. Задание 2.2. Дизайн уникального логотипа для компании</option>
							<option value="Экзамен. Задание 2.3. Дизайн титульного изображения для приложения">Экзамен. Задание 2.3. Дизайн титульного изображения для приложения</option>
							<option value="Экзамен. Задание 3.1. Дизайн схемы проезда от офиса компании к складу с наименьшими потерями">Экзамен. Задание 3.1. Дизайн схемы проезда от офиса компании к складу с наименьшими потерями</option>
							<option value="Экзамен. Задание 3.2. Дизайн оригинальной схемы размещения отделов гипермаркета в соответствии с фирменным стилем компании">Экзамен. Задание 3.2. Дизайн оригинальной схемы размещения отделов гипермаркета в соответствии с фирменным стилем компании</option>
							<option value="Экзамен. Задание 3.3. Дизайн фрагмента схемы метро с учетом требований к навигации">Экзамен. Задание 3.3. Дизайн фрагмента схемы метро с учетом требований к навигации		</option>
						</select>
					</div>		
					<div class="infoBlock">
						<label>Ссылка на результат работы</label>		
						<div class="uploadFile">
							<input type="text" placeholder="Укажите ссылку" class="workURL" name="workURL">	
							<a href="https://disc.yandex.ru" target="_blank" title="Загрузить файл" class="uploadFile"><i></i><em>Загрузить<span class="hidden"> файл</span></em></a>
							<p class="notice">Загрузите <span class="hidden">предварительно </span>файлы <span class="hidden">работы </span>на&nbsp;Яндекс.Диск</p>
						</div>
					</div>	
					<div class="infoBlock">
						<label>Текст решения задания</label>
						<textarea type="text" placeholder="Укажите текст решения задания" class="workText" name="textCompleteTask"></textarea>	
					</div>		
					<div class="notice">
					...
					<input type="submit" value="Отправить на проверку" name="upload">
				</form>
			</article>
